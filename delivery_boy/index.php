...
if(isset($_GET['set_order_id'])){
	$set_order_id=($_GET['set_order_id']);
	$delivered_on=date('Y-m-d h:i:s');
	mysqli_query($con,"update `order` set order_status=5,delivered_on='$delivered_on' where id='$set_order_id' and delivery_boy_id='".$_SESSION['DELIVERY_BOY_ID']."'");
	
}

$sql="select `order`.*,order_status.name as order_status_str from `order`,order_status where `order`.order_status=order_status.id and `order`.delivery_boy_id='".$_SESSION['DELIVERY_BOY_ID']."' and `order`.order_status!=5 order by `order`.id DESC";
   ...
   <body class="sidebar-light">
      <div class="container-scroller">
         ...
         <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <a class="nav-link " href="#" data-toggle="dropdown" id="profileDropdown" style="color:blue;">
              <span class="nav-profile-name fw-bolder"><?php echo $_SESSION['DELIVERY_BOY_USER']?></span>
            </a>
            ...
            <div class="main-panel" style="width:100%;">
                                 ...
                                 <table id="order-listing" class="table">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                         ...
                                         <td style="font-size:14px;"><?php echo $row['total_price']?>
               ...
               <footer class="footer">
                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                     <span class="text-muted text-center text-sm-left d-block d-sm-inline-block"> Copyright &copy; 2023 HomeSaaman 
                  </div>
               </footer>
               <!-- partial -->
            </div>
